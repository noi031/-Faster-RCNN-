...
class BackboneWithFPN(nn.Module):
    ...
    def __init__(self, backbone, return_layers, in_channels_list,
                 out_channels, extra_blocks = None):
...
def resnet_fpn_backbone(backbone_name, pretrained, norm_layer = misc_nn_ops.FrozenBatchNorm2d,
                        trainable_layers = 5, extra_blocks = None, returned_layers = [1, 2, 3, 4],
                        out_channels = 256):
    """
    ...
    Args:
        ...
        out_channels  (int): out_channels of FPN.
    """
...
def mobilenet_fpn_backbone(backbone_name, pretrained, norm_layer = misc_nn_ops.FrozenBatchNorm2d,
    trainable_layers = 6, extra_blocks = None, returned_layers = None, out_channels = 256):
