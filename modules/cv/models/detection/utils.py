...
def encode_boxes(reference_boxes, proposals, weights):
    ...
    targets_dw = ww * torch.log(gt_widths / ex_widths + 1e-6)
    targets_dh = wh * torch.log(gt_heights / ex_heights + 1e-6)
    targets = torch.cat((targets_dx, targets_dy, targets_dw, targets_dh), 1)
    return targets
